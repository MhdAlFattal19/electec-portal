...
slideConfig = {
  ...
  announcements = [
    ...
    approveAnnouncement(announcement: any) {
    console.log('Approved:', announcement);
    // TODO: implement approve logic (API call, update status, etc.)
  }

  declineAnnouncement(announcement: any) {
    console.log('Declined:', announcement);
    // TODO: implement decline logic (API call, update status, etc.)
  }


  viewInfo(announcement: any) {
  console.log('Info clicked:', announcement);
  this.router.navigate(['pages/announcements-management/announcement-details'])
  // TODO: Open detail view, modal, or expand section
  }

  onDeleteModalOpen(context, announcementId) {
